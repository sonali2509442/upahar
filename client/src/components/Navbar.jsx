  ...
  return (
    <nav className="flex items-center justify-between flex-wrap px-4 md:px-8 py-3 border-b border-gray-200 bg-white relative z-50">
      ...
      <div
        ...
        className="relative cursor-pointer sm:order-2 ml-auto sm:ml-0 mr-4 sm:mr-0"
      >
      ...
      <div className="hidden sm:flex items-center gap-6">
        ...
        {!user ? (
          ...
          <div ref={userMenuRef} className="relative">
            ...
            />
            {userMenu && (
              <ul className="absolute top-10 right-0 bg-white shadow border border-gray-200 py-2 w-32 rounded-md text-sm z-40">
                <li
                  onClick={() => {
                    navigate("/myorders");
                    setUserMenu(false);
        ...
        <div className="absolute top-full left-0 w-full bg-white shadow-md py-4 flex flex-col gap-4 px-6 text-sm sm:hidden">
          ...
          {!user ? (
            <button
              ...
              className="px-6 py-2 bg-primary hover:bg-primary/90 transition text-white rounded-full text-sm"
            >
              Login
            </button>
          ) : (
